...
.theme-mini{flex:none;align-self:flex-start;margin-left:auto;border:1px solid var(--border);background:var(--panel);color:var(--title);border-radius:8px;padding:4px 10px;font-size:14px;line-height:1.2;cursor:pointer;font-family:inherit}
...
@media (max-width:760px){
  ...
  button:not(.arb-exp-btn){width:100%}
...
function cbRenderTable(){
  ...
  tbl.innerHTML =
    ...
    + '<th>转债</th><th>现价</th><th>转股价值</th><th>溢价率</th><th>套利收益率</th><th>正股</th><th>双低</th><th>转股起始</th><th>状态</th>'
